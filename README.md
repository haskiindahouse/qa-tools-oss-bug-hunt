...
| Metric | Value |
|---|---|
| Issues filed | **36** across **15** projects (<=3 per project, paced) |
...
- **Security-class findings** (HTTP request/response parsing desync, prototype-pollution) go through
  each project's private disclosure channel, never a public issue.
- Some maintainers prefer their tracker stays focused on user-facing problems; those projects are
  respected and left out of this list.
